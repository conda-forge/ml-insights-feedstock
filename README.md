...
Once the `conda-forge` channel has been enabled, `ml-insights` can be installed with:

```
conda install ml-insights
```

It is possible to list all of the versions of `ml-insights` available on your platform with:
